        ...
        <Box className='Navbar'>
            <Flex minWidth='max-content' alignItems='center' gap='2'maxHeight='max-content'>
                <Box p='2'>
                    ...
                    <Image src='https://cdn.discordapp.com/attachments/1038360446383693904/1038361636211273728/pi_space_png.png' alt='logo' className='navimg' sizes='lx'  margin-left= '20px' margin-top='1vh' />    
